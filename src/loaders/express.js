...
import { OK_SUCCESS, UNKNOWN_SERVER_ERROR, prefix } from "./../config/index.js";
import routes from "./../api/routes/index.js";
import { logger } from "../utils/index.js";
import { rateLimiter, setInitialTimestamp } from "../api/middlewares/index.js";
...
export default (app) => {
  ...
  app.use(rateLimiter);
  app.use(prefix, setInitialTimestamp, routes);

  app.get("/", setInitialTimestamp, (_req, res) => {
    try {
      return success(_req, res, OK_SUCCESS, "00094");
    } catch (err) {
      return failure(_req, res, UNKNOWN_SERVER_ERROR, "00008", err.message);
    }
  });
